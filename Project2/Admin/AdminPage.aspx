...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
            <td><asp:Label ID="LabelAddTeacher" runat="server">Course Teacher:</asp:Label></td>
            <td>
                <asp:TextBox ID="AddCourseTeacher" runat="server" CssClass="input-group-sm"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Text="* Teacher Name required." ControlToValidate="AddCourseTeacher" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
